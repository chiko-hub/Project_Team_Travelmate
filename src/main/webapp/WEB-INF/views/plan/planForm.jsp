...
<!-- 새 일정 생성 패널 -->
<div id="planCreatePanel" class="panel" data-panel-group="panel">
  <h3>새 일정 생성</h3>
...
<!-- 일정 불러오기 패널 -->
<div id="planLoadPanel" class="panel" data-panel-group="panel">
  <h3>일정 불러오기</h3>
...
<!-- 직접 추가 패널 -->
<div id="planAddPanel" class="panel" data-panel-group="panel">
  <h3>새 계획 추가</h3>
...
<!-- 일정 수정 패널 -->
<div id="planUpdatePanel" class="panel" data-panel-group="panel">
  <h3>기존 계획 수정</h3>
